                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('interns.update', $intern->id) }}" method="post" enctype="multipart/form-data" class="flex flex-col items-center">
                        ...
                        <div class="flex flex-col items-center w-full">
                            ...
                            <input type="text" id="first_name" name="first_name" value="{{$intern->first_name}}" class="mb-4 mt-2 py-1 text-center rounded w-72 border border-gray-900" style="text-transform: capitalize">
                            <label for="last_name" class="self-start text-center w-full">Nom :</label>
                            <input type="text" id="last_name" name="last_name" value="{{$intern->last_name}}" class="mb-4 mt-2 py-1 text-center rounded w-72 border border-gray-900" style="text-transform: uppercase">
