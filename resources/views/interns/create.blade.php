            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('interns.store') }}" method="post" enctype="multipart/form-data" class="flex flex-col items-center">
                        ...
                        <input type="text" id="first_name" name="first_name" class="mb-4 mt-2 py-1 text-center rounded w-72 border p-2 border-gray-900">
                        <label for="last_name" class="self-start text-center w-full">Nom :</label>
                        <input type="text" id="last_name" name="last_name" class="mb-4 mt-2 py-1 text-center rounded w-72 border p-2 border-gray-900">
